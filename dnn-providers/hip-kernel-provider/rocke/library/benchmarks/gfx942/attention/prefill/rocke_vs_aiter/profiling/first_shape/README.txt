This directory contains hardware counters after profiling aiter and rocke.
Shape:
B=1
S=4096
Hq=32
...
./profile_hardware.sh
```
Results available in rocm-libraries/dnn-providers/hip-kernel-provider/rocke/library/benchmarks/gfx942/attention/prefill/rocke_vs_aiter/profiling/first_shape
